...
public enum DwcDpClasses {
  ...
  RELATIONSHIP("resource-relationship.csv", "resource-relationship", DwcDpRelationship.class),
  ...
  REFERENCE("bibliographic-resource.csv", "bibliographic-resource", DwcDpBibliographicResource.class),
