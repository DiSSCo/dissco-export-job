...
<#if chronometric_age??>
  , {
    ...
    "path" : "chronometric-age.csv"
  }
</#if>
<#if chronometric_age_agent_role??>
  , {
    ...
    "path" : "chronometric-age-agent-role.csv"
  }
</#if>
<#if identification??>
  , {
...
<#if resource_relationship??>
  , {
    ...
    "path" : "resource-relationship.csv"
  }
</#if>
<#if bibliographic_resource??>
  , {
    ...
    "path" : "bibliographic-resource.csv"
  }
</#if>
<#if usage_policy??>
  , {
